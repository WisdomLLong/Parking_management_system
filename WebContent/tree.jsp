...
var treeMenu = [
	{ level:1, name:"汽车管理"},
	{ level:2, name:"车辆费用管理", ico:"images/icon_default.gif",link:"cars/Cars_query.action"},
	{ level:2, name:"进出车辆登记", ico:"images/icon_default.gif",link:"cars/Cars_querysave.action"},
	{ level:1, name:"值班人员登记", ico:"images/icon_default.gif",link:"users/Users_queryworker.action"}
];
</script>
<style>
* {
