...
#wrapper{
	...
	overflow-x:hidden;
	overflow-y:hidden;
    background-image: -moz-linear-gradient(top,#EBEC0D, #2F368F);
    background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0, #ccff55),color-stop(1, #485a48));
}
#header{
	height:100px;
	width:100%;
...
<div id="wrapper">
	<div id="header">
		<div id="logo"></div>
		<div id="heading">
			<div id="title">停车管理系统</div>
			<div id="subTitle">Parking Management System</div>
		</div>
	</div>
	<div id="main">
		<div id="mainBg">
